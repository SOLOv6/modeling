...
#     preds = np.array([0,1,1,1,1,0])
#     result = np.array([1,0,1,0,1,0])

#     print(preds * result)
#     print(np.sum(preds * result))
#     print(np.sum(preds * (1 - result)))

#     print(np.sum(preds * result) / (np.sum(preds * result) + np.sum(preds * (1 - result)))) # precision
